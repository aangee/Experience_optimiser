class Game {
    constructor(canvasSetting) {
        ...
        // v3: AudioSource créé une seule fois ici et réutilisé à chaque tir.
        // En v2, un new AudioSource() était instancié à chaque tir → accumulation mémoire.
        this.shootSound = new AudioSource('./js/objs/audio/TestTire01');
    ...
    loop() {
        ...
        // v3: getImageData force un readback GPU→CPU, très coûteux.
        // En v2, il était appelé 2× par frame (worldCtx + gameCtx). On garde uniquement gameCtx.
